    ...
    <transition name="fade">
      <div class="model__wapper" v-show="ModalVisible">
        ...
        <div class="model">
          ...
          <div class="footer">
            <button class="btn block" @click="fetchMotd()" :disabled="querying">
              <span v-if="!querying"
                ><font-awesome-icon
                  icon="search"
